...
public class Player {
    ...
    public Player(String name, Strategy strategy) { // strategy가 부모 타입(어떤 자식 전략이든 받아서 보관 가능)
        this.name = name;
    ...
    public Hand nextHand() {
        return strategy.nextHand(); // 전략 객체에게 다음 손을 결정하도록 위임한다.(자신이 결정하는 것이 아님) => 어떤 전략 객체인지에 따라서 다음 손이 결정
    }
